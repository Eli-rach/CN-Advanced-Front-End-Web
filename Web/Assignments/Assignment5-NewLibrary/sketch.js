...
class player {
  ...
  checkJump(){
    if(this.body.colliding(floor1.body) || this.body.colliding(floor2.body)){
...
function randomPlatform(){
  ...
  let randomy = 0;
  if(pc.body.colliding(floor2.body) && floor2.body.y < floor1.body.y){
    while(randomx > 500 || randomx < 10){
      // console.log("randomx: " + randomx)
      randomx = getRandomInt(525)
    }
    
    while(randomy > cameraMin - 100){
